...
const Sidebar = () => {
  ...
  return (
    <aside className="tw:hidden tw:w-full tw:bg-black-200 tw:h-[calc(100dvh-56px)] tw:py-4 tw:px-3 tw:flex-col tw:items-start tw:justify-start tw:gap-4 tw:sticky tw:left-0 tw:xl:flex tw:xl:w-70 tw:xl:border-r tw:xl:border-r-hyperliquid-gray-100">
